...
from cardapp.forms import TableCategoryForm, TableItemsForm
...
class CatItemView(MultiFormMixin, ProcessMultipleFormsView):
    #model = TableCategory
    form_classes = {'category': TableCategoryForm,
                    'item': TableItemsForm}
